...
Пресеты хранятся в файлах `*.preset` и представляют собой Lua-файлы.
...
На данный момент наиболее сильные модели это `gpt-4o` от [OpenAI](https://platform.openai.com/), `gemini-1.5-pro` от [Google](https://ai.google/gemini-ecosystem),
